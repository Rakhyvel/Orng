...
struct1 _684_f(uint8_t _684_give_int);
...
BB7:
    _678_t10 = 1;
    _678_t11 = _678_t2.tag;
    _678_t12 = _678_t11 == _678_t10;
    if (_678_t12) {
        goto BB9;
    } else {
        goto BB13;
...
BB1:
    _684_t1 = 240;
    _684_t0 = (struct1) {.tag=1, ._1=_684_t1};
    goto BB4;
BB5:
    _684_t0 = (struct1) {.tag=2};
    goto BB4;
BB4:
    _684_$retval = _684_t0;
    return _684_$retval;
}
