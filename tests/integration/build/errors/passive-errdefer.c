...
BB694:
    _602_t7 = 100;
    *_602_x = $add_int64_t(*_602_x, _602_t7, "tests/integration/errors/passive-errdefer.orng:14:23:\n        errdefer x^ += 100\n                     ^");
    _602_t14 = 9;
    *_602_x = $add_int64_t(*_602_x, _602_t14, "tests/integration/errors/passive-errdefer.orng:11:19:\n    errdefer x^ += 9\n                 ^");
    return _602_$retval;
BB695:
