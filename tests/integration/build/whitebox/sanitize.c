...
int64_t _1983_f(struct struct1 _1983_x);


/* Function definitions */
int64_t _1981_main(void){
    function0 _1981_t0;
    struct struct1 _1981_t2;
    int64_t _1981_t1;
    int64_t _1981_$retval;
    _1981_t0 = (function0) _1983_f;
    _1981_t2 = (struct struct1) {(uint8_t*)string_0, 27};
    $lines[$line_idx++] = "tests/integration/whitebox/sanitize.orng:3:7:\n    f(\"make sure you sanitize me!\\n\")\n     ^";
    _1981_t1 = _1981_t0(_1981_t2);
    $line_idx--;
    _1981_$retval = _1981_t1;
