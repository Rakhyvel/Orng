...
int64_t _1850_f(struct struct1 _1850_x);


/* Function definitions */
int64_t _1848_main(void){
    function0 _1848_t0;
    struct struct1 _1848_t2;
    int64_t _1848_t1;
    int64_t _1848_$retval;
    _1848_t0 = (function0) _1850_f;
    _1848_t2 = (struct struct1) {(uint8_t*)string_0, 27};
    $lines[$line_idx++] = "tests/integration/whitebox/sanitize.orng:3:7:\n    f(\"make sure you sanitize me!\\n\")\n     ^";
    _1848_t1 = _1848_t0(_1848_t2);
    $line_idx--;
    _1848_$retval = _1848_t1;
