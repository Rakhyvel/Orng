...
int64_t _1978_f(struct struct1 _1978_x);


/* Function definitions */
int64_t _1976_main(void){
    function0 _1976_t0;
    struct struct1 _1976_t2;
    int64_t _1976_t1;
    int64_t _1976_$retval;
    _1976_t0 = (function0) _1978_f;
    _1976_t2 = (struct struct1) {(uint8_t*)string_0, 27};
    $lines[$line_idx++] = "tests/integration/whitebox/sanitize.orng:3:7:\n    f(\"make sure you sanitize me!\\n\")\n     ^";
    _1976_t1 = _1976_t0(_1976_t2);
    $line_idx--;
    _1976_$retval = _1976_t1;
