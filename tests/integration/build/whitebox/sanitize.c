...
int64_t _1883_f(struct struct1 _1883_x);


/* Function definitions */
int64_t _1881_main(void){
    function0 _1881_t0;
    struct struct1 _1881_t2;
    int64_t _1881_t1;
    int64_t _1881_$retval;
    _1881_t0 = (function0) _1883_f;
    _1881_t2 = (struct struct1) {(uint8_t*)string_0, 27};
    $lines[$line_idx++] = "tests/integration/whitebox/sanitize.orng:3:7:\n    f(\"make sure you sanitize me!\\n\")\n     ^";
    _1881_t1 = _1881_t0(_1881_t2);
    $line_idx--;
    _1881_$retval = _1881_t1;
