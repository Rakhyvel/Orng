...
int64_t _1816_f(struct struct1 _1816_x);


/* Function definitions */
int64_t _1814_main(void){
    function0 _1814_t0;
    struct struct1 _1814_t2;
    int64_t _1814_t1;
    int64_t _1814_$retval;
    _1814_t0 = (function0) _1816_f;
    _1814_t2 = (struct struct1) {(uint8_t*)string_0, 27};
    $lines[$line_idx++] = "tests/integration/whitebox/sanitize.orng:3:7:\n    f(\"make sure you sanitize me!\\n\")\n     ^";
    _1814_t1 = _1814_t0(_1814_t2);
    $line_idx--;
    _1814_$retval = _1814_t1;
