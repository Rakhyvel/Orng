...
int64_t _2011_main(void);
int64_t _2013_f(struct struct1 _2013_x);


/* Function definitions */
int64_t _2011_main(void){
    function0 _2011_t0;
    struct struct1 _2011_t2;
    int64_t _2011_t1;
    int64_t _2011_$retval;
    _2011_t0 = (function0) _2013_f;
    _2011_t2 = (struct struct1) {(uint8_t*)string_0, 27};
    $lines[$line_idx++] = "tests/integration/whitebox/sanitize.orng:3:7:\n    f(\"make sure you sanitize me!\\n\")\n     ^";
    _2011_t1 = _2011_t0(_2011_t2);
    $line_idx--;
    _2011_$retval = _2011_t1;
    return _2011_$retval;
}
