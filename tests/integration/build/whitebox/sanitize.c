...
int64_t _1983_main(void);
int64_t _1985_f(struct struct1 _1985_x);


/* Function definitions */
int64_t _1983_main(void){
    function0 _1983_t0;
    struct struct1 _1983_t2;
    int64_t _1983_t1;
    int64_t _1983_$retval;
    _1983_t0 = (function0) _1985_f;
    _1983_t2 = (struct struct1) {(uint8_t*)string_0, 27};
    $lines[$line_idx++] = "tests/integration/whitebox/sanitize.orng:3:7:\n    f(\"make sure you sanitize me!\\n\")\n     ^";
    _1983_t1 = _1983_t0(_1983_t2);
    $line_idx--;
    _1983_$retval = _1983_t1;
    return _1983_$retval;
}
