...
int64_t _1601_main(void){
    ...
    struct struct3* _1601_t5;
    int64_t _1601_t6;
    function4 _1601_t7;
    struct struct3* _1601_t9;
    int64_t _1601_t10;
    function6 _1601_t11;
    int64_t _1601_t8;
    ...
    _1601_t5 = &_1602_my_val;
    _1601_t6 = 2;
    _1601_t7 = (function4) _1599_c;
    $lines[$line_idx++] = "tests/integration/traits/receiver-addr.orng:18:13:\n    my_val.>c(2)\n           ^";
    (void) _1601_t7(_1601_t5, _1601_t6);
    $line_idx--;
    _1601_t9 = &_1602_my_val;
    _1601_t10 = 2;
    _1601_t11 = (function6) _1597_b;
    $lines[$line_idx++] = "tests/integration/traits/receiver-addr.orng:19:13:\n    my_val.>b(2)\n           ^";
    _1601_t8 = _1601_t11(_1601_t9, _1601_t10);
    $line_idx--;
    _1601_$retval = _1601_t8;
    return _1601_$retval;
}

void _1599_c(void* _1599_self, int64_t _1599_x){
    (*(struct struct3*)_1599_self)._0 = $mult_int64_t((*(struct struct3*)_1599_self)._0, _1599_x, "tests/integration/traits/receiver-addr.orng:13:46:\n    fn c(&mut self, x: Int) -> () { self.x *= x }\n                                            ^");
    return;
}
...
int64_t _1597_b(void* _1597_self, int64_t _1597_x){
    ...
    _1597_t0 = $mult_int64_t((*(struct struct3*)_1597_self)._1, _1597_x, "tests/integration/traits/receiver-addr.orng:11:51:\n    fn b(&self, x: Int) -> Int { self.x + self.y * x }\n                                                 ^");
    _1597_$retval = $add_int64_t((*(struct struct3*)_1597_self)._0, _1597_t0, "tests/integration/traits/receiver-addr.orng:11:42:\n    fn b(&self, x: Int) -> Int { self.x + self.y * x }\n                                        ^");
