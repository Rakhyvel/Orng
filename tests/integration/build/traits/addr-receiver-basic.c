...
int64_t _1654_main(void){
    ...
    struct struct2* _1655_my_val_ptr;
    int64_t _1654_t7;
    function3 _1654_t8;
    int64_t _1654_t6;
    int64_t _1654_t9;
    ...
    _1655_my_val_ptr = &_1655_my_val;
    _1654_t7 = 2;
    _1654_t8 = (function3) _1652_a;
    $lines[$line_idx++] = "tests/integration/traits/addr-receiver-basic.orng:15:17:\n    my_val_ptr.>a(2) + 3\n               ^";
    _1654_t6 = _1654_t8(_1655_my_val_ptr, _1654_t7);
    $line_idx--;
    _1654_t9 = 3;
    _1654_$retval = $add_int64_t(_1654_t6, _1654_t9, "tests/integration/traits/addr-receiver-basic.orng:15:23:\n    my_val_ptr.>a(2) + 3\n                     ^");
...
int64_t _1652_a(void* _1652_$self_ptr, int64_t _1652_x){
    ...
    _1652_t1 = $mult_int64_t(_1653_self._1, _1652_x, "tests/integration/traits/addr-receiver-basic.orng:9:50:\n    fn a(self, x: Int) -> Int { self.x + self.y * x }\n                                                ^");
    _1652_$retval = $add_int64_t(_1653_self._0, _1652_t1, "tests/integration/traits/addr-receiver-basic.orng:9:41:\n    fn a(self, x: Int) -> Int { self.x + self.y * x }\n                                       ^");
