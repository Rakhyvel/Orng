...
int64_t _1723_d(int64_t _1723_x, int64_t _1723_y){
    ...
    _1723_$retval = $add_int64_t(_1723_x, _1723_y, "tests/integration/traits/receiver-none.orng:10:12:\n        x + y\n          ^");
