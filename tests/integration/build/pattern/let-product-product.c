...
int64_t _1212_main(void){
    ...
    _1212_t8 = $add_int64_t(_1213_x, _1213_y, "tests/integration/pattern/let-product-product.orng:4:8:\n    x + y + a + b\n      ^");
    _1212_t9 = $add_int64_t(_1212_t8, _1213_a, "tests/integration/pattern/let-product-product.orng:4:12:\n    x + y + a + b\n          ^");
    _1212_$retval = $add_int64_t(_1212_t9, _1213_b, "tests/integration/pattern/let-product-product.orng:4:16:\n    x + y + a + b\n              ^");
