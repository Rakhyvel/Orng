...
#ifndef ORNG_1694153594827121543
#define ORNG_1694153594827121543
...
BB4:
    *(((int64_t*)(&_3_x))+_2_t6) = _2_t5;
    _2_$retval = 0;
    return _2_$retval;
BB3:
    $lines[$line_idx++] = "tests/integration/lint/array-copy-neg-bounds-check.orng:4:7:\n    x[f()] = 0\n     ^";
