...
int64_t _1088_main(void){
    ...
    _1088_t7 = 0;
    _1088_t8 = 4;
    $bounds_check(_1088_t7, _1088_t8, "tests/integration/lint/slice-copy-neg-bounds-check.orng:4:19:\n    let y = [mut]x\n                 ^");
    _1088_t9 = ((int64_t*)&_1089_x + _1088_t7);
    _1088_t10 = 4;
    _1089_y = (struct struct1) {_1088_t9, _1088_t10};
    _1088_t13 = (function2) _1090_f;
    $lines[$line_idx++] = "tests/integration/lint/slice-copy-neg-bounds-check.orng:5:9:\n    y[f()] = 0\n       ^";
    _1088_t14 = _1088_t13();
    $line_idx--;
    $bounds_check(_1088_t14, _1089_y._1, "tests/integration/lint/slice-copy-neg-bounds-check.orng:5:15:\n    y[f()] = 0\n             ^");
    *((int64_t*)_1089_y._0 + _1088_t14) = 0;
    _1088_$retval = 0;
