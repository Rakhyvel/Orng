...
int64_t _1088_main(void){
    ...
    _1088_t6 = 0;
    _1088_t7 = 4;
    $bounds_check(_1088_t6, _1088_t7, "tests/integration/lint/slice-copy-neg-bounds-check.orng:4:19:\n    let y = [mut]x\n                 ^");
    ...
    _1088_t12 = _1088_t11();
    $line_idx--;
    $bounds_check(_1088_t12, _1089_y._1, "tests/integration/lint/slice-copy-neg-bounds-check.orng:5:15:\n    y[f()] = 0\n             ^");
    *((int64_t*)_1089_y._0 + _1088_t12) = 0;
    _1088_$retval = 0;
