...
BB1332:
    _1160_t16 = $sub_int64_t(_1160_t14, _1160_t13, "tests/integration/lint/subslice-bounds.orng:5:15:\n    let z = y[f()..1]\n             ^");
    _1160_t17 = _1161_y._0+_1160_t13;
    _1161_z = (struct struct1) {_1160_t17, _1160_t16};
    _1160_t20 = 0;
    $bounds_check(_1160_t20, _1161_z._1, "tests/integration/lint/subslice-bounds.orng:2:8:\nfn main() -> Int {\n      ^");
    _1160_$retval = *((int64_t*)_1161_z._0 + _1160_t20);
