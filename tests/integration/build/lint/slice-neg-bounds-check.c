...
int64_t _1136_main(void){
    ...
    _1136_t7 = 0;
    _1136_t8 = 4;
    $bounds_check(_1136_t7, _1136_t8, "tests/integration/lint/slice-neg-bounds-check.orng:4:16:\n    let y = []x\n              ^");
    ...
    _1136_t13 = _1136_t12();
    $line_idx--;
    $bounds_check(_1136_t13, _1137_y._1, "tests/integration/lint/slice-neg-bounds-check.orng:2:8:\nfn main() -> Int {\n      ^");
