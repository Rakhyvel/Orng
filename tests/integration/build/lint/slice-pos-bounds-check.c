...
int64_t _1071_main(void){
    ...
    _1071_t6 = 0;
    _1071_t7 = 4;
    $bounds_check(_1071_t6, _1071_t7, "tests/integration/lint/slice-pos-bounds-check.orng:4:16:\n    let y = []x\n              ^");
    ...
    _1071_t11 = _1071_t10();
    $line_idx--;
    $bounds_check(_1071_t11, _1072_y._1, "tests/integration/lint/slice-pos-bounds-check.orng:2:3:\nfn main() -> Int {\n ^");
