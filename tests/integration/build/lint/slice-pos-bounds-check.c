...
int64_t _1061_main(void){
    ...
    _1061_t6 = 0;
    _1061_t7 = 4;
    $bounds_check(_1061_t6, _1061_t7, "tests/integration/lint/slice-pos-bounds-check.orng:4:16:\n    let y = []x\n              ^");
    ...
    _1061_t11 = _1061_t10();
    $line_idx--;
    $bounds_check(_1061_t11, _1062_y._1, "tests/integration/lint/slice-pos-bounds-check.orng:2:3:\nfn main() -> Int {\n ^");
    _1061_$retval = *((int64_t*)_1062_y._0 + _1061_t11);
