...
int64_t _1145_main(void){
    ...
    _1145_t7 = 0;
    _1145_t8 = 4;
    $bounds_check(_1145_t7, _1145_t8, "tests/integration/lint/slice-copy-pos-bounds-check.orng:4:19:\n    let y = [mut]x\n                 ^");
    ...
    _1145_t14 = _1145_t13();
    $line_idx--;
    $bounds_check(_1145_t14, _1146_y._1, "tests/integration/lint/slice-copy-pos-bounds-check.orng:5:15:\n    y[f()] = 0\n             ^");
