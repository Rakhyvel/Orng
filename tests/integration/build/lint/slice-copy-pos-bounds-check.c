...
int64_t _1068_main(void){
    ...
    _1068_t7 = 0;
    _1068_t8 = 4;
    $bounds_check(_1068_t7, _1068_t8, "tests/integration/lint/slice-copy-pos-bounds-check.orng:4:19:\n    let y = [mut]x\n                 ^");
    ...
    _1068_t14 = _1068_t13();
    $line_idx--;
    $bounds_check(_1068_t14, _1069_y._1, "tests/integration/lint/slice-copy-pos-bounds-check.orng:5:15:\n    y[f()] = 0\n             ^");
