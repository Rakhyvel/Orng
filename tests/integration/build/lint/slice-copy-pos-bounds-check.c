...
int64_t _1046_main(void){
    ...
    _1046_t6 = 0;
    _1046_t7 = 4;
    $bounds_check(_1046_t6, _1046_t7, "tests/integration/lint/slice-copy-pos-bounds-check.orng:4:19:\n    let y = [mut]x\n                 ^");
    ...
    _1046_t12 = _1046_t11();
    $line_idx--;
    $bounds_check(_1046_t12, _1047_y._1, "tests/integration/lint/slice-copy-pos-bounds-check.orng:5:15:\n    y[f()] = 0\n             ^");
