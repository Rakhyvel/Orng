...
struct3 _36_safe_div_vec(struct2 _36_x,struct2 _36_y) {
    ...
    _36_t5 = _36_t4(*((int64_t*)&_36_x + _36_t6), *((int64_t*)&_36_y + _36_t7));
    $line_idx--;
    _36_t8 = 0;
    *((struct4*)&_37_retval + _36_t8) = _36_t5;
    _36_t9 = _38_safe_div;
    _36_t11 = 1;
    _36_t12 = 1;
    $lines[$line_idx++] = "tests/integration/arrays/array-optional.orng:10:26:\n    retval[1] = safe_div(x[1], y[1])\n                        ^";
    _36_t10 = _36_t9(*((int64_t*)&_36_x + _36_t11), *((int64_t*)&_36_y + _36_t12));
    $line_idx--;
    _36_t13 = 1;
    *((struct4*)&_37_retval + _36_t13) = _36_t10;
    _36_t14 = _38_safe_div;
    _36_t16 = 2;
    _36_t17 = 2;
    $lines[$line_idx++] = "tests/integration/arrays/array-optional.orng:11:26:\n    retval[2] = safe_div(x[2], y[2])\n                        ^";
    _36_t15 = _36_t14(*((int64_t*)&_36_x + _36_t16), *((int64_t*)&_36_y + _36_t17));
    $line_idx--;
    _36_t18 = 2;
    *((struct4*)&_37_retval + _36_t18) = _36_t15;
