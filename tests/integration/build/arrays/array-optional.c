...
int64_t _34_main(void){
    ...
    _34_t12 = (*((struct struct4*)&_35_res + _34_t10)).tag;
    ...
    _34_$retval = (*((struct struct4*)&_35_res + _34_t10))._0;
    return _34_$retval;
}
...
struct struct3 _36_safe_div_vec(struct struct2 _36_x, struct struct2 _36_y){
    ...
    *((struct struct4*)&_37_retval + _36_t26) = _36_t21;
