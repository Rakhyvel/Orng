...
int64_t _80_main(void){
    ...
    *((int64_t*)((struct struct0*)&_81_x + _80_t19) + _80_t21) = $add_int64_t(*((int64_t*)((struct struct0*)&_81_x + _80_t13) + _80_t15), _80_t17, "tests/integration/arrays/multi-dim.orng:8:15:\n    x[1][2] += 1 // nice\n             ^");
    _80_t23 = 1;
    _80_t24 = 3;
    _80_t25 = 2;
    _80_t26 = 3;
    ...
    _80_$retval = *((int64_t*)((struct struct0*)&_81_x + _80_t23) + _80_t25);
    return _80_$retval;
}
