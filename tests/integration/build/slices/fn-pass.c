...
int64_t _1211_f(struct1 _1211_x);
...
int64_t _1209_main(void) {
    ...
    _1209_t6 = 0;
    _1209_t7 = ((int64_t*)&_1210_x + _1209_t6);
    _1209_t8 = 4;
    _1210_y = (struct1) {_1209_t7, _1209_t8};
    _1209_t9 = _1211_f;
    $lines[$line_idx++] = "tests/integration/slices/fn-pass.orng:5:7:\n    f(y)\n     ^";
    _1209_t10 = _1209_t9(_1210_y);
    $line_idx--;
    _1209_$retval = _1209_t10;
...
int64_t _1211_f(struct1 _1211_x) {
    ...
    _1211_t0 = 1;
    _1211_t1 = 80;
    _1211_$retval = $add_int64_t(*((int64_t*)_1211_x._0 + _1211_t0), _1211_t1, "tests/integration/slices/fn-pass.orng:8:28:\nfn f(x: []Int)->Int {x[1] + 80}\n                          ^");
