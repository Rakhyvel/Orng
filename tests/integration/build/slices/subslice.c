...
BB2:
    ...
    _4_sum = $add_int64_t(_4_sum, *((int64_t*)_3_xs._0 + _5_i), "tests/integration/slices/subslice.orng:13:15:\n        sum += xs[i]\n             ^");
    _5_i = $add_int64_t(_5_i, 1, "tests/integration/slices/subslice.orng:12:50:\n    while let mut i: Int = 0; i < xs.length; i += 1 {\n                                                ^");
    goto BB1;
BB7:
    _3_$retval = _4_sum;
    return _3_$retval;
