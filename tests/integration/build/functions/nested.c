...
BB10:
    ...
    $line_idx--;
    _3_t0 = _8_add(_3_fib($sub_int64_t(_3_n, 1, "tests/integration/functions/nested.orng:8:32:\n            else => add(fib(n - 1), fib(n - 2))\n                              ^")), _3_fib($sub_int64_t(_3_n, 2, "tests/integration/functions/nested.orng:8:44:\n            else => add(fib(n - 1), fib(n - 2))\n                                          ^")));
BB5:
    _3_$retval = _3_t0;
    return _3_$retval;
}
