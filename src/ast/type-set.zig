//! This file defines type sets and directed acyclic graphs (DAGs) for types. The type set is used to store types based
//! on their C-equivalence. The DAG is used to store the dependencies between types, and is used to generate a
//! topological sort of the types.
