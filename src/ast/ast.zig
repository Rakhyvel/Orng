...
pub const AST = union(enum) {
    ...
    pub fn clone(self: *AST, substs: *unification_.Substitutions, allocator: std.mem.Allocator) *AST {
        switch (self.*) {
            ...
            .context_param_decl => return create_context_param_decl(self.token(), allocator),
            .context_decl => {
    ...
    pub fn pprint(self: AST, allocator: std.mem.Allocator) ![]const u8 {
        ...
        switch (self) {
            ...
            .context_param_decl => try out.print("context_param_decl({s})", .{self.type_param_decl.common._token.data}),
            .context_decl => {
