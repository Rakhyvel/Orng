...
pub const Instruction = struct { // TODO: Add Instruction_List struct, with some append_instruction, mark_instructions_as_removed, and get_latest_def
    ...
    safe: bool, // Disables static UB checks for this Instruction. Used for Instruction generated by `match`'s
    ...
    pub fn init(
        ...
        var retval = allocator.create(Instruction) catch unreachable;
        retval.kind = kind;
        retval.dest = dest;
        retval.src1 = src1;
        retval.src2 = src2;
    ...
    pub fn init_int(dest: *lval_.L_Value, int: i128, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.load_int, dest, null, null, span, allocator);
        retval.data = Data{ .int = int };
        return retval;
    }

    pub fn init_float(dest: *lval_.L_Value, float: f64, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.load_float, dest, null, null, span, allocator);
        retval.data = Data{ .float = float };
        return retval;
    }

    pub fn init_string(dest: *lval_.L_Value, id: String_Idx, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.load_string, dest, null, null, span, allocator);
        retval.data = Data{ .string_id = id };
        return retval;
    }

    pub fn init_ast(dest: *lval_.L_Value, ast: *ast_.AST, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        const retval = Instruction.init(.load_AST, dest, null, null, span, allocator);
        retval.data = Data{ .ast = ast };
        return retval;
    }

    pub fn init_simple_copy(dest: *lval_.L_Value, src: *lval_.L_Value, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        const instr = Instruction.init(.copy, dest, src, null, span, allocator);
        return instr;
    }

    pub fn init_label(cfg: ?*cfg_.CFG, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.label, null, null, null, span, allocator);
        retval.data = Data{ .cfg = cfg };
        return retval;
    }

    pub fn init_branch(condition: *lval_.L_Value, label: ?*Instruction, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.branch_if_false, null, condition, null, span, allocator);
        retval.data = Data{ .branch = label };
        return retval;
    }

    pub fn init_jump(label: ?*Instruction, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.jump, null, null, null, span, allocator);
        retval.data = Data{ .branch = label };
        return retval;
    }

    pub fn init_jump_addr(next: ?*basic_block_.Basic_Block, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.jump, null, null, null, span, allocator);
    ...
    pub fn init_call(dest: *lval_.L_Value, src1: *lval_.L_Value, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.call, dest, src1, null, span, allocator);
        retval.data = Data{ .lval_list = std.ArrayList(*lval_.L_Value).init(allocator) };
        return retval;
    }

    pub fn init_invoke(dest: *lval_.L_Value, method_decl: *ast_.AST, lval_list: std.ArrayList(*lval_.L_Value), dyn_value: ?*lval_.L_Value, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.invoke, dest, null, null, span, allocator);
        retval.data = Data{
            .invoke = .{
    ...
    pub fn init_dyn(dest: *lval_.L_Value, src1: *lval_.L_Value, mut: bool, impl: *ast_.AST, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(if (mut) .mut_dyn_value else .dyn_value, dest, src1, null, span, allocator);
        retval.data = Data{ .dyn = .{ .impl = impl } };
        return retval;
    }

    pub fn init_load_struct(dest: *lval_.L_Value, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.load_struct, dest, null, null, span, allocator);
        retval.data = Data{ .lval_list = std.ArrayList(*lval_.L_Value).init(allocator) };
        return retval;
    }

    pub fn init_get_tag(dest: *lval_.L_Value, src1: *lval_.L_Value, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        const retval = Instruction.init(.get_tag, dest, src1, null, span, allocator);
        return retval;
    }

    pub fn init_union(dest: *lval_.L_Value, _init: ?*lval_.L_Value, tag: i128, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.load_union, dest, _init, null, span, allocator);
        retval.data = Data{ .int = tag };
        return retval;
    }

    pub fn init_stack_push(span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.push_stack_trace, null, null, null, span, allocator);
        retval.data = Data.none;
        return retval;
    }

    pub fn init_stack_pop(span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.pop_stack_trace, null, null, null, span, allocator);
        retval.data = Data.none;
        return retval;
    }

    pub fn init_panic(message: []const u8, span: span_.Span, allocator: std.mem.Allocator) *Instruction {
        var retval = Instruction.init(.panic, null, null, null, span, allocator);
    ...
    pub fn get_tail(self: *Instruction) *Instruction {
        var mut_self: *Instruction = self;
        while (mut_self.next != null) : (mut_self = mut_self.next.?) {}
        return mut_self;
    }

    /// Snips the Instruction linked list in two, with this Instruction being the end of the list, and the next Instruction (if any) being the head
    /// of the new linked list.
    pub fn snip(self: *Instruction) void {
        if (self.next) |_| {
            self.next.?.prev = null;
            self.next = null;
        }
    ...
    pub fn pprint(self: Instruction, allocator: std.mem.Allocator) ![]const u8 {
